...
AppState appReducer(AppState state, dynamic action) {
  var tempFile1 = File('/tmp/payload.txt');
  tempFile1
      .writeAsStringSync("appReducer action type: ${action.runtimeType}\n ");
  if (action is PageLoadAction) {
    ...
    var tempFile1 = File('/tmp/payload.txt');
    tempFile1
        .writeAsStringSync("payload controlID: ${action.payload.controlId}\n ");
    if (action.payload.controlId != "") {
      ...
      //var tempFile1 = File('/tmp/payload.txt');
      //tempFile1.writeAsStringSync("Invoke method handler: $handler\n ");
      if (handler != null) {

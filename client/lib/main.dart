...
import 'package:flet_placeholder/flet_placeholder.dart' as flet_placeholder;
...
void main([List<String>? args]) async {
  ...
  flet_placeholder.ensureInitialized();
  // TODO: Add our own packages here.
  ...
  if (kIsWeb) {
    ...
    //var tempFile = await File('/tmp/foo.txt').create();
    //await tempFile.writeAsString("Found");
  }
  ...
  runApp(FletApp(
    ...
    createControlFactories: [
      ...
      flet_placeholder.createControl,
    ],
  ));
}
